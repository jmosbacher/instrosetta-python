...
class PowerMeterStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Echo = channel.unary_unary(
        '/instrosetta.interfaces.light_analysis.power_meter.v1.PowerMeter/Echo',
        request_serializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.EchoRequest.SerializeToString,
        response_deserializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.EchoResponse.FromString,
        )
    self.Connect = channel.unary_unary(
        '/instrosetta.interfaces.light_analysis.power_meter.v1.PowerMeter/Connect',
        request_serializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.ConnectRequest.SerializeToString,
        response_deserializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.ConnectResponse.FromString,
        )
    self.Disconnect = channel.unary_unary(
        '/instrosetta.interfaces.light_analysis.power_meter.v1.PowerMeter/Disconnect',
        request_serializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.DisconnectRequest.SerializeToString,
        response_deserializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.DisconnectResponse.FromString,
        )
...
def add_PowerMeterServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Echo': grpc.unary_unary_rpc_method_handler(
          servicer.Echo,
          request_deserializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.EchoRequest.FromString,
          response_serializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.EchoResponse.SerializeToString,
      ),
      'Connect': grpc.unary_unary_rpc_method_handler(
          servicer.Connect,
          request_deserializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.ConnectRequest.FromString,
          response_serializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.ConnectResponse.SerializeToString,
      ),
      'Disconnect': grpc.unary_unary_rpc_method_handler(
          servicer.Disconnect,
          request_deserializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.DisconnectRequest.FromString,
          response_serializer=instrosetta_dot_interfaces_dot_light__analysis_dot_power__meter__pb2.DisconnectResponse.SerializeToString,
      ),
